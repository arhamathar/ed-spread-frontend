...
const PrivacyPolicy = () => {
    return (
        <div className='routes-height text-light'>
            <div className='courseh1 pb-5'>
                <h1>Privacy Policy of Ed Spread</h1>
            </div>
            <div className='px-5'>
                <p>
                    Ed Spread operates the https://www.edspread.in/ website,
                ...
                <p>
                    ...
                    https://www.edspread.in/, unless otherwise defined in this
                    Privacy Policy.
                </p>
            </div>
            <div className='px-5'>
                <h2 className='mt-5 mb-3'>Information Collection and Use</h2>
            ...
            <div className='px-5'>
                <h2 className='mt-5 mb-3'>Log Data</h2>
            ...
            <div className='px-5'>
                <h2 className='mt-5 mb-3'>Cookies</h2>
            ...
            <div className='px-5'>
                <h2 className='mt-5 mb-3'>Service Providers</h2>
            ...
            <div className='px-5'>
                <h2 className='mt-5 mb-3'>Security</h2>
            ...
            <div className='px-5'>
                <h2 className='mt-5 mb-3'>Links to Other Sites</h2>
            ...
            <div className='px-5'>
                <h2 className='mt-5 mb-3'>Changes to This Privacy Policy</h2>
