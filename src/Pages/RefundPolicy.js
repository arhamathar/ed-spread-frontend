...
const RefundPolicy = () => {
    return (
        <div className='routes-height text-light'>
            <h1 className='courseh1'>Return and Refund Policy</h1>
            <div className='px-5'>
                <p>Last updated: January 12, 2022</p>
                <p>Thank you for shopping at Ed Spread.</p>
                <p>
            ...
            <div className='px-5'>
                <h1 className='mt-5 mb-3'>Interpretation and Definitions</h1>
                <h2 className='mt-5 mb-3'>Interpretation</h2>
                <p>
            ...
            <div className='px-5'>
                <h2 className='mt-5 mb-3'>Definitions</h2>
                ...
                <ul>
                    <li>
                        <p>
                            ...
                            refers to Ed Spread, Pragati nagar, Kukatpally,
                    ...
                    <li>
                        <p>
                            <strong>Website</strong> refers to Ed Spread,
                            accessible from{' '}
                            <a
                                href='https://www.edspread.in/'
            ...
            <div className='px-5'>
                <h1 className='mt-5 mb-3'>Your Order Cancellation Rights</h1>
                <p>
                ...
                <ul>
                    <li>By email: support@edspread.in</li>
                </ul>
                <p>
            ...
            <div className='px-5'>
                <h1 className='mt-5 mb-3'>Conditions for Returns</h1>
                <p>
            ...
            <div className='px-5'>
                <h1 className='mt-5 mb-3'>Gifts</h1>
                <p>
