...
const TermsAndCondition = () => {
    return (
        <div className='routes-height text-light'>
            <h2 className='courseh1'>
                <strong>Terms and Conditions</strong>
            </h2>
            <div className='px-5'>
                <p>Welcome to www.edspread.in!</p>

                <p>
                    These terms and conditions outline the rules and regulations
                    for the use of Ed Spread's Website, located at
                    https://www.edspread.in/.
                </p>

                <p>
                    By accessing this website we assume you accept these terms
                    and conditions. Do not continue to use www.edspread.in if
            ...
            <div className='px-5'>
                ...
                <p>
                    We employ the use of cookies. By accessing www.edspread.in,
                    you agreed to use cookies in agreement with the Ed Spread's
                    Privacy Policy.{' '}
                </p>
            ...
            <div className='px-5'>
                ...
                <p>
                    Unless otherwise stated, Ed Spread and/or its licensors own
                    the intellectual property rights for all material on
                    www.edspread.in. All intellectual property rights are
                    reserved. You may access this from www.edspread.in for your
                ...
                <p>You must not:</p>
                <ul>
                    <li>Republish material from www.edspread.in</li>
                    <li>
                        Sell, rent or sub-license material from www.edspread.in
                    </li>
                    <li>
                        Reproduce, duplicate or copy material from
                        www.edspread.in
                    </li>
                    <li>Redistribute content from www.edspread.in</li>
                </ul>
                ...
                <p>
                    ...
                    the website. Ed Spread does not filter, edit, publish or
                    review Comments prior to their presence on the website.
                    Comments do not reflect the views and opinions of Ed
                    Spread,its agents and/or affiliates. Comments reflect the
                    views and opinions of the person who post their views and
                    opinions. To the extent permitted by applicable laws, Ed
                    Spread shall not be liable for the Comments or for any
                ...
                <p>
                    Ed Spread reserves the right to monitor all Comments and to
                ...
                <p>
                    You hereby grant Ed Spread a non-exclusive license to use,
            ...
            <div className='px-5'>
                ...
                <p>
                    ...
                    compensates the absence of Ed Spread; and (d) the link is in
                ...
                <p>
                    ...
                    inform us by sending an e-mail to Ed Spread. Please include
                ...
                <p>
                    No use of Ed Spread's logo or other artwork will be allowed
